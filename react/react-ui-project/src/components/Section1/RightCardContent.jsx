...
const RightCardContent = (props) => {
  ...
  return (
    <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
        ...
        <div>
          <p className='text-shadow-2xs text-lg leading-relaxed text-white mb-10 font-semibold'> 
            {props.intro}</p>
          <div className='flex justify-between'>
            ...
            <button style={{backgroundColor:props.color}} className='text-white font-medium px-4 py-2 rounded-full text-lg'><i className="ri-arrow-right-line"></i></button>
          </div> 
        </div>
    </div>
  )
